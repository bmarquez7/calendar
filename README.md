...
4. If this project was already deployed before featured-event and expiry support, run `data/patch_featured_expiry.sql` in SQL Editor.
5. Configure `web/shared/config.js`:
   - `SUPABASE_URL`
   - `SUPABASE_ANON_KEY`
